...
- **Batch B (content & surfaces):** ✅ 7 legal docs (real `/legal/<slug>` URLs: eula/terms/privacy/waiver) · ☐ 2 · ☐ 4 · ✅ 13 roster medical alerts · ✅ 8 live telemetry (favorite + transactions, read-only)
