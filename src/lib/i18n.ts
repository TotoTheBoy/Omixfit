...
export const t = {
  ...
  pwa: {
    ...
    useMenu: "לפתיחת ההתקנה השתמשי בתפריט הדפדפן ← 'התקן אפליקציה'.",
    iosTitle: "הוספה למסך הבית",
    iosStep1: "1. לחץ/י על כפתור השיתוף בתחתית הדפדפן (⬆️).",
    iosStep2: "2. גלול/י למטה ובחר/י ב'הוסף למסך הבית' (➕).",
  },
